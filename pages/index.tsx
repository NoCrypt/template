    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      ...
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center max-w-3xl">
        ...
        <p className="pt-5">
          ...
          What's configured? black themed by default, no system pref theme, no flasing, font configured, next themes ready, using pnpm, custom documents configured, components folder setup, 404 custom error.
